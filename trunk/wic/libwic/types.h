...
//!	\brief Максимальное количество моделей арифметического кодера
/*! Это число необходимо большей частью для отладки т.к. позволяет генерировать
	более контрастные изображения значений полей элементов спектра (wnode).
*/
static const unsigned MAX_ACODER_MODELS	= 0xF0;
