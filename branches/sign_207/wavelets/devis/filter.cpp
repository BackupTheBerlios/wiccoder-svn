...
FilterSet Petuhov1 (TRUE, PetuhovAnalysis,22,-10, PetuhovSynthesis,14,-6);
FilterSet Petuhov2 (TRUE, PetuhovAnalysis2,11,0, PetuhovSynthesis2,7,0);
/*---------------------------------------------------------------------------*/
// Destructor
